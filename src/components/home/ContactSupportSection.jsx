...
<div className="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.05] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.25)] backdrop-blur-2xl sm:rounded-[32px] sm:p-8">
              ...
              <div className="overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl">
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-white/8">
                ...
                <button className="mt-5 w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-white/10 sm:w-auto">
                  Send Email
                </button>
              </div>
            ...
            <div className="rounded-3xl sm:rounded-[32px] border border-white/10 bg-white/[0.05] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.25)] backdrop-blur-2xl sm:p-8">
              ...
              <form className="space-y-5">
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 sm:px-5 text-sm text-white outline-none placeholder:text-white/30 focus:border-fuchsia-400/40"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full resize-none rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 sm:px-5 text-sm text-white outline-none placeholder:text-white/30 focus:border-fuchsia-400/40"
                  />
                </div>
  
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 sm:px-5 text-xs leading-6 text-white/50">
                ...
                <div className="flex flex-col gap-4 pt-2 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <button
                    type="submit"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-fuchsia-500 to-violet-500 px-6 py-3 text-sm font-medium text-white shadow-[0_12px_30px_rgba(168,85,247,0.35)] transition hover:scale-[1.01] sm:w-auto"
                  >
                    <Send size={16} />
                    Send Message
                  </button>

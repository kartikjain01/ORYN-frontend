    ...
    <section className="relative overflow-hidden px-6 pt-16 md:px-10 lg:px-14">
      <div className="relative mx-auto flex min-h-[700px] md:min-h-[820px] lg:min-h-[920px] w-full max-w-[1512px] flex-col items-center text-center">
        ...
        <div className="relative z-10 mt-[-10px] flex justify-center">
          <img
            src="/src/assets/images/robot-hero.png"
            alt="AI robot"
        ...
        >
          Revolutionize your workflow with a unified ecosystem for high-fidelity cloning,
          instant text-to-speech generation, and surgical audio refinement.
          From a 60-second sample to a masterpiece, control every syllable.
        </p>
